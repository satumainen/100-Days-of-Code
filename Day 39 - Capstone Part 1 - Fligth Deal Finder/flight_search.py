...
#Remember to hide
AMADEUS_FLIGHT_SEARCH_SECRET = os.environ['AMADEUS_FLIGHT_SEARCH_SECRET']
AMADEUS_FLIGHT_SEARCH_API_KEY = os.environ['AMADEUS_FLIGHT_SEARCH_API_KEY']
...
class FlightSearch:
    ...
    def _get_new_token(self):
        ...
        body = {
            ...
            'client_id': AMADEUS_FLIGHT_SEARCH_API_KEY,
            'client_secret': AMADEUS_FLIGHT_SEARCH_SECRET
        }
